  ...
  async renderHTML(req, res) {
    ...
    res.send(`
      ...
      <head>
        <meta charset="utf-8">
        <title>${ogTitle}</title>
        <meta name="description" content="dogepool - Your Gateway to explore Dogecoin's Blockchain with dogepool.space"/>
        ...
        <meta property="twitter:description" content="Your Gateway to explore Dogecoin's Blockchain with dogepool.space"/>
        <meta property="twitter:image:src" content="${ogImageUrl}"/>
        <meta property="twitter:domain" content="dogepool.space">
      <body></body>
      </html>
    `);
  }
